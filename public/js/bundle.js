...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.handleChangeID = function (e) {
            var target = e.target,
                name = target.name,
                value = target.value;
        ...
        _this.handleGetId = function () {
            _this.setState({
                checkUser: false
            });
            _axios2.default.post('/getID', {
                idcomment: _this.state.idcomment,
                iduser: _this.state.iduser
            }).then(function (res) {
                _this.setState({
                    listUser: res.data.comments.data,
                    checkUser: true
                });
            });
        };
        ...
        _this.state = {
            listUser: [],
            idcomment: '1658013307817884',
            iduser: '1194883420643558',
            checkUser: true
        };
        return _this;
    }
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            var html = !this.state.checkUser ? _react2.default.createElement(_loading2.default, null) : '';
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-xs-6 col-sm-6 col-md-6 col-lg-6 col-md-offset-3' },
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'idcomment', placeholder: 'Search for...', onChange: this.handleChangeID, value: this.state.idcomment })
                                    ),
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement('input', { type: 'text', className: 'form-control', name: 'iduser', placeholder: 'Search', onChange: this.handleChangeID, value: this.state.iduser })
                                    ),
                                    _react2.default.createElement('br', null),
                                    _react2.default.createElement(
                                        'button',
                                        { className: 'btn btn-danger', type: 'button', onClick: function onClick() {
                                                return _this2.handleGetId();
                                            } },
                                        'Go!'
                                    )
                                )
                        ...
                        _react2.default.createElement(
                            ...
                            this.state.listUser.map(function (e, i) {
                                return _react2.default.createElement(
                                    'li',
                                    { className: 'list-group-item', key: i },
                                    _react2.default.createElement(
                                        'a',
                                        { href: 'http://facebook.com/' + e.from.id },
                                        e.from.name
                                    )
                                );
                            })
